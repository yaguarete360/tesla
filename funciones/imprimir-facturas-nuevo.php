<?php if (!isset($_SESSION)) {session_start();}
    ...
    $dimensiones_pagina = array(330, 216); // array(280, 236);
    $pdf->AddPage('P', $dimensiones_pagina);
...
// ----- Cabecera
    ...
    $campos_unicos['fecha_dia']['y'] = 40 + 2;
    $campos_unicos['fecha_dia']['x'] = 50 - 10;
    $campos_unicos['fecha_dia']['ancho'] = 6;

    $campos_unicos['fecha_mes']['y'] = 40 + 2;
    $campos_unicos['fecha_mes']['x'] = 63 + 0;
    $campos_unicos['fecha_mes']['ancho'] = 40;

    $campos_unicos['fecha_anho']['y'] = 40 + 3;
    $campos_unicos['fecha_anho']['x'] = 117 - 2;
    $campos_unicos['fecha_anho']['ancho'] = 5;

    $campos_unicos['condicion_de_venta-contado']['y'] = 40 + 3;
    $campos_unicos['condicion_de_venta-contado']['x'] = 176 - 7;
    $campos_unicos['condicion_de_venta-contado']['ancho'] = 5;

    $campos_unicos['condicion_de_venta-credito']['y'] = 40 + 3;
    $campos_unicos['condicion_de_venta-credito']['x'] = 196 - 7;
    $campos_unicos['condicion_de_venta-credito']['ancho'] = 5;

    $campos_unicos['ruc']['y'] = 50 + 2;
    $campos_unicos['ruc']['x'] = 35 + 0;
    $campos_unicos['ruc']['ancho'] = 175;

    $campos_unicos['cuenta']['y'] = 60 - 2;
    $campos_unicos['cuenta']['x'] = 57 + 0;
    $campos_unicos['cuenta']['ancho'] = 81;
    
    $campos_unicos['nota_de_remision']['y'] = 60 - 7;
    $campos_unicos['nota_de_remision']['x'] = 163 + 3;
    $campos_unicos['nota_de_remision']['ancho'] = 42;

// ----- Pie

    $campos_unicos['subtotales-exentas']['y'] = 130 - 6;
    $campos_unicos['subtotales-exentas']['x'] = 140;
    $campos_unicos['subtotales-exentas']['ancho'] = 15;
    
    $campos_unicos['subtotales-iva_05']['y'] = 130 - 6;
    $campos_unicos['subtotales-iva_05']['x'] = 162;
    $campos_unicos['subtotales-iva_05']['ancho'] = 15;
    
    $campos_unicos['subtotales-iva_10']['y'] = 130 - 6;
    $campos_unicos['subtotales-iva_10']['x'] = 180;
    $campos_unicos['subtotales-iva_10']['ancho'] = 20;

    $campos_unicos['total_a_pagar_letras']['y'] = 139 - 10;
    $campos_unicos['total_a_pagar_letras']['x'] = 46 - 2;
    $campos_unicos['total_a_pagar_letras']['ancho'] = 135;

    $campos_unicos['total_a_pagar_monto']['y'] = 139 - 10;
    $campos_unicos['total_a_pagar_monto']['x'] = 184 - 2;
    $campos_unicos['total_a_pagar_monto']['ancho'] = 22;
    
    $campos_unicos['ivas-iva_05']['y'] = 143 - 10;
    $campos_unicos['ivas-iva_05']['x'] = 63;
    $campos_unicos['ivas-iva_05']['ancho'] = 37;

    $campos_unicos['ivas-iva_10']['y'] = 143 - 9;
    $campos_unicos['ivas-iva_10']['x'] = 112;
    $campos_unicos['ivas-iva_10']['ancho'] = 30;

    $campos_unicos['ivas-total']['y'] = 143 - 8;
    $campos_unicos['ivas-total']['x'] = 155;
    $campos_unicos['ivas-total']['ancho'] = 55;

// ----- Detalle

    $campos_repetidos_y = 75;
    $campos_repetidos_x = 12;
    $campos_repetidos_altura = 4;
    $campos_repetidos['cantidad'] = 21;
    $campos_repetidos['descripcion'] = 91;
    $campos_repetidos['precio_unitario'] = 11;
    $campos_repetidos['monto-exentas'] = 23;
    $campos_repetidos['monto-iva_05'] = 21;
    $campos_repetidos['monto-iva_10'] = 22;

// ----- Impresion

    for ($i_duplicado=0; $i_duplicado <= 1; $i_duplicado++)
    { 
        $subtotales['iva_10'] = 0;
        $ivas_sumas['iva_10'] = 0;
        $subtotales['iva_05'] = 0;
        ...
        $base_duplicado = $i_duplicado * 165;
        $y_a_usar = $base_duplicado + $campos_repetidos_y;
        $pdf->SetY($y_a_usar);
        ...
        foreach ($campos_unicos as $campo_nombre => $campo_datos)
        {
            ...
            $y_a_usar = $base_duplicado + $campo_datos['y'];
            $pdf->SetY($y_a_usar);
