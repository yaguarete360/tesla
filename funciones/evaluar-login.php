...
else
{
	...
	AND (finalizacion > "'.date('Y-m-d').'" or finalizacion = "0000-00-00")
	AND borrado LIKE "no"';
...
catch (Exception $e) 
{
	...
	$ubicacion_del_header = (isset($_POST['ubicacion_del_header'])) ? ltrim($_POST['ubicacion_del_header'], '/') : 'index.php';
	header('Location:../'.$ubicacion_del_header);
} 
