...
<script type="text/javascript">
    ...
    $('#sitio_emprendimiento,#sitio_linea,#sitio_area,#sitio_sendero,#sitio_sitio').change(function()
    {
            ...
            && /^[0-9]+$/.test(sitio_sitio))
        {
            ...
            $.ajax({
                type: "POST",
                url: nivel_de_url+"funciones/autocompletar-seleccion-de-sitio.php",
                data: 'sitio_a_buscar='+sitio_final,
                success: function(data) {
                    ...
                    if(data && data['estado'])
                    {
                        ...
                        document.getElementById("dato_a_mostrar_sitio").innerHTML = data['cuenta'];
                    }
                    else
                    {
                        $('#armar_sitio').val('');
                        document.getElementById("dato_a_mostrar_sitio").innerHTML = '';
