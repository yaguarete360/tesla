<?php if (!isset($_SESSION)) {session_start();}
	...
	$estructuras['IORDEN']['control'] = 'PARQUE SERENIDAD'; // PARQUE SERENIDAD
	...
	// $estructuras['INRODO']['valor'] = ' '; // numero de documento del funcionario en los txt anteriores esta vacio -- traer de organigrama?? -- RUC/CI??
