	...
	echo '<div class="row">';
		echo '<div class="col-md-5">';
			echo '<section class="home-section" style="overflow: hidden;">';
				echo '<header>';
					echo '<h2>Exequias</h2>';
					echo '<h6 style="width:100%;text-align:center;font-size:11px;text-transform:none;">Accedé al Memorial Online haciendo click en un nombre.</h6>';
				echo '</header>';
				echo '<article>';
...
// 	            	echo '<a href="https://api.whatsapp.com/send?phone=+595986106382" target="_blank">';
// 	              		echo '<img src="imagenes/iconos/mensaje-especial-area-8.png"  alt="Promocion">'; // width=750
// 	            	echo '</a>';
// 	            echo '</div>';  
//             echo '</div>';
