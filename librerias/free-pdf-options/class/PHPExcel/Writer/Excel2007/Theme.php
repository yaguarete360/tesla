						...
						$objWriter->startElement('a:fillStyleLst');
							...
							$objWriter->writeAttribute('rotWithShape', '1');
								...
								$objWriter->startElement('a:gsLst');
									...
									$objWriter->writeAttribute('post', '0');
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('post', '35000');
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('post', '100000');
							...
							$objWriter->writeAttribute('rotWithShape', '1');
								...
								$objWriter->startElement('a:gsLst');
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('post', '80000');
						...
						$objWriter->startElement('a:bgFillStyleLst');
							...
							$objWriter->writeAttribute('rotWithShape', '1');
								...
								$objWriter->startElement('a:gsLst');
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('post', '40000');
