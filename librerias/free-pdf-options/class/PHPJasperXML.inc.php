        ...
        if($cndriver=="mysql") {
            ...
            if(!$this->con) {
                ...
                if($this->myconn) {
                    ...
                    $seldb = $this->myconn->select_db($db_or_dsn_name);
                    if($seldb) {
                        $this->con = true;
                        return true;
                    }
...
//        $b=$data->subreportParameter;
    ...
    public function transferDBtoArray($host,$user,$password,$db_or_dsn_name,$cndriver="mysql") {
        ...
        if($cndriver=="odbc") {
            ...
            $result = $this->myconn->query($this->sql); //query from db
...
//echo "$pchartfolder/class/pData.class.php";die;
    ...
    $result = $this->myconn->query($sql); //query from db
    $chartdata=array();
    $i=0;
//echo $sql."<br/><br/>";
    $seriesname=array();
...
//echo $sql;die;
        ...
        $sql=$this->sql;
    //echo $sql;die;
    $result = @mysqli_query($sql); //query from db
    $chartdata=array();
    $i=0;
//echo $sql."<br/><br/>";
    $seriesname=array();
...
//						echo $out["hidden_type"]."<br/>";
            ...
            ?>
            <div class="notFound">
            <?php echo "No existe datos a visualizar!!";?>
            </div>
            <?php
...
*/
    ...
    public function print_expression($data) {
        ...
        if($expression!=""){
            ...
            //$sss = 'if("'.$expression.'"){$this->print_expression_result=true;}';
            //echo $sss;
            //die();
